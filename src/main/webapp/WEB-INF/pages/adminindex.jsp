...
<title>Admin Index Page is here</title>
</head>
<body class="leftside_panel">

	<h3 id="user" style="color: purple">${requestScope.message}</h3>
	<input type="button" value="logout" id="index_btn"
		onclick="changeframes()" />
	<a href="addvehicle.ren" target="frame2">Add Vehicle</a>

	<a href="bookvehicle.ren" target="frame2">Book Vehicle</a>

	<a href="bookingreport.ren" target="frame2">Vehicle Report</a>
